...
#define PanSource	"scheduling_system.pml"
...
#define nstates1	29	/* SchedulingSystem */
#define endstate1	28
short src_ln1 [] = {
	  0,  50,  51,  52,  50,  55,  56,  57, 
	 55,  49,  60,  48,  66,  67,  68,  69, 
	 66,  71,  72,  73,  74,  75,  71,  65, 
	 78,  64,  81,  82,  84,   0, };
S_F_MAP src_file1 [] = {
	{ ""-"", 0, 0 },
	{ "scheduling_system.pml", 1, 28 },
	{ ""-"", 29, 30 }
};
uchar reached1 [] = {
	  0,   1,   1,   1,   0,   1,   1,   1, 
...
#define nstates0	23	/* Student */
#define endstate0	22
short src_ln0 [] = {
	  0,  13,  14,  15,  12,  21,  22,  23, 
	 21,  25,  26,  27,  25,  20,  30,  19, 
	 35,  36,  37,  34,  41,  42,  43,   0, };
S_F_MAP src_file0 [] = {
	{ ""-"", 0, 0 },
	{ "scheduling_system.pml", 1, 22 },
	{ ""-"", 23, 24 }
};
uchar reached0 [] = {
	  0,   1,   0,   0,   0,   1,   1,   1, 
...
#define PSchedulingSystem	((P1 *)this)
typedef struct P1 { /* SchedulingSystem */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
} P1;
#define Air1	(sizeof(P1) - 3)
#define PStudent	((P0 *)this)
typedef struct P0 { /* Student */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
} P0;
...
typedef struct State {
	...
	unsigned anyConflict : 1;
	uchar channel;
	uchar sv[VECTORSZ];
} State;

#define HAS_TRACK	0
/* hidden variable: */	uchar preferencesSent;
